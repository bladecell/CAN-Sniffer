...
const std::map<uint8_t, PIDInfo> OBD2::PID_DEF = {
    {PID_ENGINE_LOAD, {MODE_CURRENT_DATA, PID_ENGINE_LOAD, "Engine Load", PERCENTAGE, "Calculated engine load", OBDFormulas::engineLoad, 0.0f, 100.0f, 2}},
    {PID_COOLANT_TEMP, {MODE_CURRENT_DATA, PID_COOLANT_TEMP, "Coolant Temp", DEGREES_CELCIUS, "Engine coolant temperature", OBDFormulas::coolantTemp, -40.0f, 215.0f, 3}},
    {PID_ENGINE_RPM, {MODE_CURRENT_DATA, PID_ENGINE_RPM, "Engine RPM", RPM, "Engine speed", OBDFormulas::engineRPM, 0.0f, 16383.75f, 1}},
    // ... more definitions
};
...
void OBD2::initDef()
{
    ...
    {
        pidData[pid] = {0.0f, 0, {0}, false, false, 100};
    }
}
...
esp_err_t OBD2::getData(uint8_t pid, PIDData &pd) const
{
