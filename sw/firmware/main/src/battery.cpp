...
static constexpr float R_TOP         = 1000000.0f;
static constexpr float R_BOT         = 270000.0f;
...
esp_err_t battery_init()
{
    ...
    ESP_RETURN_ON_ERROR(adc_oneshot_config_channel(adc_handle, ADC_CHANNEL_2, &chan_cfg), TAG,
